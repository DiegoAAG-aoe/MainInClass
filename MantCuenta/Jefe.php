...
<section class="content">
    <div class="row clearfix">
        <div >
            <div>
                <div>
                    <a class="btn btn-info" href="add_jefe.php">Anadir Jefe Carrera</a>
                    <h2 style="text-align: center;">Gestion Jefe Carrera</h2>
                </div>
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($con, "select * from jefec");
