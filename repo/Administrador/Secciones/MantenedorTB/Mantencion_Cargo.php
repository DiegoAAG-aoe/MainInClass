...
?>
    <div class=text-center><h4 class="h4t">Mantención de Cargos</h4></div>
    <div>
        <a href="Mantencion_Tablas.php" class="button button5" role="button" Style="margin-top:0rem;margin-left:20rem;">Regresar</a>
        <a href="Añadir_Cargo.php" class="button button5" Style="margin-top:5rem;" role="button">Agregar Nuevo Cargo</a>
    </div>
    <br><br><br>
...
<?php
    ...
    $query = "  SELECT C.Car_ID, C.Car_Nombre, C.Car_Estado
            FROM Cargo C
    ...
    if ($result = $mysqli->query($query)) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<tr>  
                ...
                <td width="10%" class="filas2"><h5><a href="Cargo.php?Cargo=' . $field1name . '"" class="button button5" role="button">Editar</a></h5></td>
              </tr>';
        }
        $result->free();
    }
