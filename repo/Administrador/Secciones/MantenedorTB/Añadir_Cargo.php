...
if (isset($_SESSION['user_g']) || isset($_SESSION['user_a'])) {
    ...
    $sql = "INSERT INTO Cargo (Car_Nombre,Car_Estado) 
            VALUES ('$txtNombre', $txtEstado)";

    if ($Accion=='Agregar'){
        mysqli_query($mysqli, $sql);
        header("Location: Mantencion_Cargo.php", TRUE, 301);
        exit();
    }
    ...
    <div class="col-md-5" style="margin-top: 5rem; margin-left:30rem; margin-bottom: 5rem; padding-right: 2rem; margin-right: 30rem; padding-left: 0rem;">
